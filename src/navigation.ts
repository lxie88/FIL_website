  ...
  links: [
    ...
    },
    {
      ...
      links: [
        {
          text: 'Faculty',
          href: getPermalink('/team/faculty'),
        },
        {
          text: 'Researchers',
          href: getPermalink('/team/researchers'),
        },
        {
          text: 'Students',
          href: getPermalink('/team/students'),
        },
        {
          text: 'Alumni',
...
export const footerData = {
  links: [
    ...
    },
    {
      title: 'Team',
      links: [
        { text: 'Faculty', href: getPermalink('/team/faculty') },
        { text: 'Researchers', href: getPermalink('/team/researchers') },
        { text: 'Students', href: getPermalink('/team/students') },
